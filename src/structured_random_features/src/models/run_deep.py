...
parser.add_argument('--structured', dest='structured', action='store_true',
                    help='use structured random init')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.pretrained:
        ...
        if args.structured:
            print("=> creating model 'alexnet' (structured)")
            model = models.alexnet(structured=True)
        else:
            print("=> creating model 'alexnet' (unstructured)")
            model = models.alexnet(structured=False)
