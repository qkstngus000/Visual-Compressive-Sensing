...
def usage():
    print(
        ...
        arg[4] = observation_type ex)classical, V1, gaussian
...
def main() :
    ...
    param_path = data_save_path(image_nm, method, observation, "param_{dwt_type}_".format(dwt_type = dwt_type) + "_".join(str.split(time.ctime().replace(":", "_"))))
